...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>QuocHuanMC chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "QuocHuanMC", HidePremium = false, IntroText = "QuocHuanMC⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("QuocHuanMC SCRIPT")
W:AddLabel("DiscordQuocHuanMC")
local Section = W:AddSection({
    Name = "Status"
})
